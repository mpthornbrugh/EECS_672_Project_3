...
void set3DViewingInformation(double xyz[6])
{
	...
	cryph::AffPoint eye(xmid - distEyeCenter, ymid, zmid);
	...
	double ecZpp = -(distEyeCenter - 0.25*maxDelta);
	double ecZmin = ecZpp - maxDelta;
	double ecZmax = ecZpp + maxDelta;
...
{
	GLFWControllerSub c("Bedroom", MVC_USE_DEPTH_BIT);
	...
	cryph::Matrix4x4 scale = cryph::Matrix4x4::scale(1.0, 1.0, 1.0);
	addBasicArrowHead(c, p4, (scale * xRot * yRot * zRot));
